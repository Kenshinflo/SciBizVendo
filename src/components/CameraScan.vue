                ...
                <div class="bg-white min-h-96 px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div class="">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:text-left">
                        ...
                        <p class="text-stone-400 font-mono mt-2 mx-2 text-md leading-5 ">Please display the QR code generated by the Paytaca app near the camera</p>
                        <div class="camera w-full min-h-96 flex flex-col items-center justify-between rounded-md bg-gray-600 mt-5 ">  
                            <!-- <div class="mt-20">
